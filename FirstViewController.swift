...
class FirstViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    let fruit = [["Pink Salmon", "Chum Salmon", "Coho Salmon", "Sockeye Salmon", "Chinook Salmon", "Black Cod", "Black Rockfish", "YellowEye Rockfish", "Pacific Halibut" ]]
    let fishAb: [[Double]] = [[0.0089, 3.25], [0.1408, 3.00], [0.0112, 3.0],[0.01555, 3], [0.01333,3], [0.0102, 3.03], [0.02111, 3.0], [0.01384, 3.00], [0.0071, 3.10]]
